...
import com.dluvian.volare.data.nostr.createDescriptionTag
import com.dluvian.volare.data.nostr.createMentionTags
import com.dluvian.volare.data.nostr.createQuoteTags
import com.dluvian.volare.data.nostr.createSubjectTag
import com.dluvian.volare.data.nostr.createTitleTag
...
class EventMaker(
    ...
    private fun addClientTag(tags: MutableList<Tag>, isAnon: Boolean) {
        ...
        tags.add(createVolareClientTag())
    }
}
