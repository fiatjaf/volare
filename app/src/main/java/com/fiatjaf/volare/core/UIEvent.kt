...
data class OpenThreadRaw(val pointer: backend.EventPointer) : AdvancedPushNavEvent()
data class OpenProfile(val pointer: backend.ProfilePointer) : AdvancedPushNavEvent()
